 ...
 * @version 2.1
 *****/
public class GraphJPanel extends JPanel implements MouseListener, MouseMotionListener, ActionListener, ImageReader
{
...
JMenuItem mnRemPU,mnUnlinkPU,mnMinLPU,mnMinPPU,mnRenPU,mnColSetPU,mnWeightPU,mnZoomPU,mnSizePU,mnImagePU,mnShapePU,mnFillPU;
 ...
 *******/
public GraphJPanel(Graph gr, Image bg, String bgn)
  {
  g=gr;
  bgImage=bg;
  bgName=bgn;
...
/******
 * Crea un GraphPanel prelevando dal Reader r la matrice di adiacenza il cui formato
 ...
 *************/
public JButtonChanger(Button f,GraphPanel gp)
  {
  this.gp=gp;
  this.f=f;
  }
